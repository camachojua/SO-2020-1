...
*** Imprimir un caracter en memoria
...
#+BEGIN_SRC sh
gcc -c -g -Os -march=native -ffreestanding -Wall -Werror floppy.c -o floppy.o
ld -static -Tfloppy.ld -nostdlib -nmagic -o floppy.elf floppy.o
